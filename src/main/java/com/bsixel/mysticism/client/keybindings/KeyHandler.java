...
public class KeyHandler {
    ...
    public static void handleKeyEvent(InputEvent.KeyInputEvent event) {
        ...
        if (event.getKey() == Keybindings.CAST_SPELL.getKey().getKeyCode() && event.getAction() == GLFW.GLFW_PRESS) { // TODO: Figure out how to stop key propagation
        ...
        } else if (event.getKey() == Keybindings.SELECT_SPELL.getKey().getKeyCode() && event.getAction() == GLFW.GLFW_PRESS) {

...
public interface ISpellAction extends ISpellComponent { // Break, hurt, heal, grow etc, subclasses
    ...
    boolean applyToEntity(World world, EntityRayTraceResult trace, ISpellInstance spellInstance, SpellComponentInstance wrapper); // TODO: Each component should handle self-casts separately inside here with an entity comparison check
    boolean applyToBlock(World world, BlockRayTraceResult trace, ISpellInstance spellInstance, SpellComponentInstance wrapper);
